        ...
        <div class="card-body p-5">
          ...
          <p class="font-medium text-sm text-neutral-600 dark:text-white mt-3 mb-0 flex items-center gap-2">
            <span class="inline-flex items-center gap-1 text-success-600 dark:text-success-400">
              <iconify-icon icon="bxs:up-arrow" class="text-xs"></iconify-icon> +4000
            </span> Last 30 days users
          </p>
        </div>
      </div>
      <!-- card end -->
      <div class="card shadow-none border border-gray-200 dark:border-neutral-600 dark:bg-neutral-700 rounded-lg h-full bg-gradient-to-r from-purple-600/10 to-bg-white">
        <div class="card-body p-5">
          ...
          <p class="font-medium text-sm text-neutral-600 dark:text-white mt-3 mb-0 flex items-center gap-2">
            ...
            </span> Last 30 days subscription
          </p>
        </div>
      </div>
      <!-- card end -->
        ...
        <div class="card h-full rounded-lg border-0">
          <div class="card-body">
            ...
            <div class="flex flex-wrap items-center gap-2 mt-2">
              ...
              <span class="text-sm font-semibold rounded-full bg-success-100 dark:bg-success-600/25 text-success-600 dark:text-success-400 border border-success-200 dark:border-success-600/50 px-2 py-1.5 line-height-1 flex items-center gap-1"> 10% <iconify-icon icon="bxs:up-arrow" class="text-xs"></iconify-icon>
              </span>
        ...
        <div class="card h-full rounded-lg border-0">
          <div class="card-body p-6">
            ...
            <div class="flex items-center gap-2 mb-5">
              ...
              <span class="text-sm font-semibold rounded-full bg-danger-100 dark:bg-danger-600/25 text-danger-600 dark:text-danger-400 border border-danger-200 dark:border-danger-600/50 px-2 py-1.5 line-height-1 flex items-center gap-1"> 10% <iconify-icon icon="iconamoon:arrow-down-2-fill" class="icon"></iconify-icon>
              </span> - 20 Per Day
            </div>
            <div id="barChart"></div>
          </div>
          ...
          <div class="card-body p-6">
            ...
            <ul class="flex flex-wrap items-center justify-between mt-4 gap-3">
              <li class="flex items-center gap-2">
                ...
                <span class="text-secondary-light text-sm font-normal">New: <span class="text-neutral-600 dark:text-neutral-200 font-semibold">400</span>
                </span>
              </li>
              <li class="flex items-center gap-2">
                <span class="w-3 h-3 rounded-sm bg-warning-600"></span>
                <span class="text-secondary-light text-sm font-normal">Subscribed: <span class="text-neutral-600 dark:text-neutral-200 font-semibold">300</span>
                </span>
              </li>
            </ul>
          </div>
            ...
            <div class="mb-4">
              <ul class="tab-style-gradient flex flex-wrap -mb-px text-sm font-medium text-center" id="default-tab" data-tabs-toggle="#default-tab-content" role="tablist">
                <li class="" role="presentation">
                  <button class="py-2.5 px-4 border-t-2 font-semibold text-lg inline-flex items-center gap-3 text-neutral-600" id="registered-tab" data-tabs-target="#registered" type="button" role="tab" aria-controls="registered" aria-selected="false"> Latest Registered <span class="text-white px-2 py-0.5 bg-neutral-600 rounded-full text-sm">20</span>
                  </button>
                </li>
                <li class="" role="presentation">
                  <button class="py-2.5 px-4 border-t-2 font-semibold text-lg inline-flex items-center gap-3 text-neutral-600 hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300" id="subscribe-tab" data-tabs-target="#subscribe" type="button" role="tab" aria-controls="subscribe" aria-selected="false"> Latest Subscribe <span class="text-white px-2 py-0.5 bg-neutral-600 rounded-full text-sm">20</span>
                  </button>
                </li>
              </ul>
            </div>
                  ...
                  <table class="table bordered-table sm-table mb-0 table-auto">
                    ...
                    <tbody>
                      <tr>
                        <td>
                          <div class="flex items-center">
                            <img src="assets/images/users/user1.png" alt="" class="w-10 h-10 rounded-full shrink-0 me-2 overflow-hidden">
                            <div class="grow">
                      ...
                      <tr>
                        <td>
                          <div class="flex items-center">
                            <img src="assets/images/users/user2.png" alt="" class="w-10 h-10 rounded-full shrink-0 me-2 overflow-hidden">
                            <div class="grow">
                      ...
                      <tr>
                        <td>
                          <div class="flex items-center">
                            <img src="assets/images/users/user3.png" alt="" class="w-10 h-10 rounded-full shrink-0 me-2 overflow-hidden">
                            <div class="grow">
                      ...
                      <tr>
                        <td>
                          <div class="flex items-center">
                            <img src="assets/images/users/user4.png" alt="" class="w-10 h-10 rounded-full shrink-0 me-2 overflow-hidden">
                            <div class="grow">
                      ...
                      <tr>
                        <td>
                          <div class="flex items-center">
                            <img src="assets/images/users/user5.png" alt="" class="w-10 h-10 rounded-full shrink-0 me-2 overflow-hidden">
                            <div class="grow">
        ...
        <div class="card h-full border-0">
          <div class="card-body">
            <div class="flex items-center flex-wrap gap-2 justify-between">
              ...
              <a href="javascript:void(0)" class="text-primary-600 dark:text-primary-600 hover-text-primary flex items-center gap-1"> View All <iconify-icon icon="solar:alt-arrow-right-linear" class="icon"></iconify-icon>
              </a>
            </div>
            <div class="mt-8">
              <div class="flex items-center justify-between gap-2 mb-6">
                <div class="flex items-center gap-3">
                  <img src="assets/images/users/user1.png" alt="" class="w-10 h-10 rounded-full shrink-0 overflow-hidden">
                  <div class="grow">
                    <h6 class="text-base mb-0 font-medium">Dianne Russell</h6>
              ...
              <div class="flex items-center justify-between gap-2 mb-6">
                <div class="flex items-center gap-3">
                  <img src="assets/images/users/user2.png" alt="" class="w-10 h-10 rounded-full shrink-0 overflow-hidden">
                  <div class="grow">
                    <h6 class="text-base mb-0 font-medium">Wade Warren</h6>
                    <span class="text-sm text-secondary-light font-medium">Agent ID: 36254</span>
                  </div>
              ...
              <div class="flex items-center justify-between gap-2 mb-6">
                <div class="flex items-center gap-3">
                  <img src="assets/images/users/user3.png" alt="" class="w-10 h-10 rounded-full shrink-0 overflow-hidden">
                  <div class="grow">
                    <h6 class="text-base mb-0 font-medium">Albert Flores</h6>
                    <span class="text-sm text-secondary-light font-medium">Agent ID: 36254</span>
                  </div>
              ...
              <div class="flex items-center justify-between gap-2 mb-6">
                <div class="flex items-center gap-3">
                  <img src="assets/images/users/user4.png" alt="" class="w-10 h-10 rounded-full shrink-0 overflow-hidden">
                  <div class="grow">
                    <h6 class="text-base mb-0 font-medium">Bessie Cooper</h6>
                    <span class="text-sm text-secondary-light font-medium">Agent ID: 36254</span>
                  </div>
              ...
              <div class="flex items-center justify-between gap-2 mb-6">
                <div class="flex items-center gap-3">
                  <img src="assets/images/users/user5.png" alt="" class="w-10 h-10 rounded-full shrink-0 overflow-hidden">
                  <div class="grow">
                    <h6 class="text-base mb-0 font-medium">Arlene McCoy</h6>
                    <span class="text-sm text-secondary-light font-medium">Agent ID: 36254</span>
                  </div>
              ...
              <div class="h-full border border-neutral-200 dark:border-neutral-600 p-4 pe-0 rounded-lg">
                <div class="max-h-[266px] overflow-y-auto scroll-sm pe-6">
                  <div class="flex items-center justify-between gap-3 mb-3 pb-2">
                    <div class="flex items-center">
                      <img src="assets/images/flags/flag1.png" alt="" class="w-10 h-10 rounded-full shrink-0 me-4">
                      <div class="grow">
                  ...
                  <div class="flex items-center justify-between gap-3 mb-3 pb-2">
                    <div class="flex items-center">
                      <img src="assets/images/flags/flag2.png" alt="" class="w-10 h-10 rounded-full shrink-0 me-4">
                      <div class="grow">
                  ...
                  <div class="flex items-center justify-between gap-3 mb-3 pb-2">
                    <div class="flex items-center">
                      <img src="assets/images/flags/flag3.png" alt="" class="w-10 h-10 rounded-full shrink-0 me-4">
                      <div class="grow">
                  ...
                  <div class="flex items-center justify-between gap-3 mb-3 pb-2">
                    <div class="flex items-center">
                      <img src="assets/images/flags/flag4.png" alt="" class="w-10 h-10 rounded-full shrink-0 me-4">
                      <div class="grow">
                  ...
                  <div class="flex items-center justify-between gap-3 mb-3 pb-2">
                    <div class="flex items-center">
                      <img src="assets/images/flags/flag5.png" alt="" class="w-10 h-10 rounded-full shrink-0 me-4">
                      <div class="grow">
          ...
          <div class="card-body">
            ...
            <ul class="flex flex-wrap items-center mt-4 gap-3">
              <li class="flex items-center gap-2">
                ...
                <span class="text-secondary-light text-sm font-semibold">Word: <span class="text-neutral-600 dark:text-neutral-200 font-bold">400</span>
                </span>
              </li>
              <li class="flex items-center gap-2">
                <span class="w-3 h-3 rounded-full bg-warning-600"></span>
                <span class="text-secondary-light text-sm font-semibold">Image: <span class="text-neutral-600 dark:text-neutral-200 font-bold">300</span>
                </span>
              </li>
            </ul>
            <div class="mt-[60px]">
